...
- Advanced search syntax: wildcards (`*`, `?`) and regex (`/pattern/`)
- Incremental indexing for faster startup (scans only changed directories)
- Database performance improvements and stale entry cleanup
